...
ENV JAVA_OPTS="-javaagent:/pinpoint-agent-1.8.5/pinpoint-bootstrap-1.8.5.jar -Dpinpoint.agentId=springboot.board -Dpinpoint.applicationName=board-$SPRING_PROFILES_ACTIVE"
